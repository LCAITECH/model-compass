# CHANGELOG_ARCHIVE.md — Model Compass

Older entries moved out of `CHANGELOG.md` to keep that file under the
project's 400-line ceiling (`AGENTS.md`). Same format, same rules —
this is a continuation of `CHANGELOG.md`, not a different document.
